...
fn test_p010() {
    run_and_compare_output(
        "tests/suite/P010.BAS",
        "tests/suite/P010.ok",
        "tests/suite/P010.eok",
    );
}
...
fn test_p011() {
    run_and_compare_output(
        "tests/suite/P011.BAS",
        "tests/suite/P011.ok",
        "tests/suite/P011.eok",
    );
}
...
fn test_p012() {
    run_and_compare_output(
        "tests/suite/P012.BAS",
        "tests/suite/P012.ok",
        "tests/suite/P012.eok",
    );
}
...
fn test_p015() {
    run_and_compare_output(
        "tests/suite/P015.BAS",
        "tests/suite/P015.ok",
        "tests/suite/P015.eok",
    );
}
